#!/usr/bin/env python3
"""
Run SEC Report with 70/30 Config
=================================

Generates the SEC Championship Scouting Report using the 70/30 weightings config.
"""
...
def main():
    ...
    print("="*80)
    print("GENERATING SEC REPORT WITH 70/30 WEIGHTINGS")
    print("="*80)
    ...
    for position_name in position_profiles:
        ...
        # Calculate scores with 70/30 weights
        print(f"  🧮 Calculating scores with 70/30 weightings...")
        df_scored = reports_module.calculate_with_historical_normalization(
    ...
    output_file = base_dir / "Portland Thorns 2025 SEC Championship Scouting Report_70_30.xlsx"
    wb.save(output_file)
    print(f"\n✅ Report saved: {output_file.name}")
    print(f"   Using 70/30 weightings (70% intent, 30% accuracy)")
    
    print("\n" + "="*80)
    print("✅ SEC REPORT GENERATED WITH 70/30 WEIGHTINGS")
    print("="*80)
