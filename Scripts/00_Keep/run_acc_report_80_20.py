#!/usr/bin/env python3
"""
Run ACC Report with 80/20 Config
=================================

Generates the ACC Championship Scouting Report using the 80/20 weightings config.
"""
...
def main():
    ...
    print("="*80)
    print("GENERATING ACC REPORT WITH 80/20 WEIGHTINGS")
    print("="*80)
    ...
    # Save with the correct filename for ACC Championship Report
    output_file = base_dir / "Mike_Norris_Scouting_Report_ACC_IntraConference_80_20.xlsx"
    wb.save(output_file)
    print(f"\n✅ Report saved: {output_file.name}")
    print(f"   Using 80/20 weightings (80% intent, 20% accuracy)")
    
    print("\n" + "="*80)
    print("✅ ACC REPORT GENERATED WITH 80/20 WEIGHTINGS")
    print("="*80)
